                        ...
                        <div class="inner bg-light lter">
                         <div class="body" style="margin-top: 10px; margin-left: -45px;">
                            ...
                            ?>
                                ...
                                <form id="myform" class="form-horizontal" method="POST" action="action/recordstudents_edit_action.php?studentID=<?php echo $studentID?>">
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-4"></label>

                                    <div class="col-lg-8">
                                         <a class="user-link" data-toggle="modal" data-target="#modal-changepic">
                                ...
                                <div class="form-group">
                                    <label for="text1" class="control-label col-lg-4">Alum Name</label>
